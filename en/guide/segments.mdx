...
In **Segments**, create a new segment via the **Editor** or **AI Chat** (describe your target audience and AI builds the rules — see [Building with AI](/en/guide/building-with-ai)):
...
<Note>
  AI suggestions are controlled by the **Automatic AI segment suggestions** setting in **Settings → Project**, and generating them consumes [AI credits](/en/guide/ai-credits).
</Note>
