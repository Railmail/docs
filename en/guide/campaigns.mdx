...
| **AI Chat** | AI-guided creation. Pick a goal — **Newsletter, Product update, Promotion or Win-back** — and the assistant drafts content, subject lines and preview text. See [Building with AI](/en/guide/building-with-ai). Consumes [AI credits](/en/guide/ai-credits) and needs a connection (offline switches to the Editor). |
