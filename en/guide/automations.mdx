...
| **AI Flow Builder** | Switch to **Chat** and describe your goal in plain language — AI generates the whole flow on the canvas, which you then review and refine. See [Building with AI](/en/guide/building-with-ai). |
