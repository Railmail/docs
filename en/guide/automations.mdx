...
| **Assistant flow builder** | Switch to **Chat** and describe your goal in plain language — the assistant generates the whole flow on the canvas, which you then review and refine. See [Building with the assistant](/en/guide/building-with-ai). |
