...
<Steps>
  ...
  <Step title="Przejdź onboarding">
    Kreator onboardingu konfiguruje przestrzeń roboczą. Podaj adres swojej strony lub krótki opis biznesu — asystent go analizuje i przygotowuje projekt: tematy e-mail, segmenty odbiorców, startowe automatyzacje, klucze API, rekordy domeny i domyślne szablony wiadomości.
  </Step>
</Steps>
